...
- Keep the home story zone-selected, transition-queued, and dwell-based; captions follow the active zone while settled state controls attention and telemetry, and saved Ask answers replay locally without requests.
