...
export const EVENT_DIM_KEYS: Readonly<Record<string, readonly string[]>> = {
  ...
  "mcp.push": ["attachment_count", "attachment_versions", "channel", "degraded_refusals", "entry", "has_suggestion", "mode", "rejected_attachments", "source", "suggestion_outcome", "target", "tool", "vendor", "windowed"],
