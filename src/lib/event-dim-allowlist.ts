...
export const EVENT_DIM_KEYS: Readonly<Record<string, readonly string[]>> = {
  ...
  "mcp.push": ["attachment_count", "attachment_versions", "attachments_placed", "channel", "degraded_refusals", "entry", "has_suggestion", "mode", "rejected_attachments", "source", "suggestion_outcome", "target", "tool", "vendor", "windowed"],
