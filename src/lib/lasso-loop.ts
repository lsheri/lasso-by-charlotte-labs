...
function targetForForm(index: number, form: LassoResolvedForm): ShapePoint {
  if (form === 0) {
    return polylinePoint([
      { x: 0.76, y: 0.23 }, { x: 0.66, y: 0.14 }, { x: 0.48, y: 0.14 },
      { x: 0.33, y: 0.24 }, { x: 0.28, y: 0.38 }, { x: 0.34, y: 0.48 },
      { x: 0.47, y: 0.49 }, { x: 0.59, y: 0.4 }, { x: 0.62, y: 0.25 },
      { x: 0.59, y: 0.44 }, { x: 0.53, y: 0.64 }, { x: 0.43, y: 0.79 },
      { x: 0.34, y: 0.84 }, { x: 0.47, y: 0.85 }, { x: 0.64, y: 0.79 },
      { x: 0.79, y: 0.67 }, { x: 0.87, y: 0.57 },
    ], index / (LOOP_STAMPS - 1));
  }
