      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-12 space-y-10">
          ...
          <Section label="02" title="How your work gets in">
            ...
            <p>
              Connectors and MCP push are opt-in, per source and per item. Everything lands private
              and unmapped. It becomes shareable only when you map it.
            </p>
          </Section>
          ...
          <Section label="05" title="Deletion">
            <p>
              You can delete any piece of your work at any time. Deleting your account removes your
              content. Uploaded files are removed from storage with the items that reference them.
            </p>
          </Section>
