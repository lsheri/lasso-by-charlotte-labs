...
export type LabNodeEventKind = "source" | "ai_work" | "human_judgment" | "decision" | "deliverable" | "draft_thread" | "shape";
...
export function noteWorkboardElementResized(orgId: string | undefined, elementKind: "card" | "frame" | "shape", method: "pointer" | "keyboard" | "fit_content", axis: "horizontal" | "vertical" | "both"): void {
