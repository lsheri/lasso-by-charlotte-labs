...
export const ARCHIVED_HERO_H1_FALLBACK = "Your firm bought AI. Now nobody can say where a number came from.";
export const ARCHIVED_HERO_H1 = "Your firm bought AI. The human judgment, process, and thinking in your team's work went invisible.";
...
export function ArchivedB2BLanding() {
  // Archived copy: inert. No events, no session replay, no network on submit.
  ...
  function inertPlayed(_card: UseCaseKey, _mode: "hover" | "tap") {}
        ...
        <main className="landing-beats-root pb-24 pt-16 md:pt-20">
          ...
          <section className="landing-usecases mx-auto mt-24 max-w-[1200px] px-4 md:px-6" aria-label="What consultants use it for">
            ...
            <div className="landing-usecase-grid">
              {USE_CASES.map((card) => <UseCaseCard key={card.key} card={card} onPlayed={inertPlayed} />)}
            </div>
          </section>
